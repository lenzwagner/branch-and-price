...
from instance_setup import *  # Use local modified version with severity_mix support
...
class ColumnGeneration:
    ...
    def __init__(self, seed, app_data, T, D_focus, max_itr=100, threshold=1e-5,
                 ...
                 dual_smoothing_alpha=0.5, T_demand=None, pre_generated_data=None, severity_mix=None):
        """
        ...
        self.severity_mix = severity_mix

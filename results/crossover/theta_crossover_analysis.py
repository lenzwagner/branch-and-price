    ...
    for n_remove in reduction_list:
        ...
        for current_k in k_learn_list:
            ...
            if crossover_theta is not None:
                ...
                lp_path_baseline_app = os.path.join(
                    lp_base_dir,
                    f"baseline_app_T{T}_rem{n_remove}_theta{crossover_theta:.3f}_k{current_k}"
                )
        ...
        print(f"  \U0001f4ca Analytical Prediction:")
        ...
        print(f"  \U0001f4c8 Theoretical Equivalent Starting Proficiencies (for avg N_k = {avg_N_k:.2f} sessions):")
